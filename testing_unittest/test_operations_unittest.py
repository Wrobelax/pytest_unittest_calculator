...
# Creating test cases for addition.
    ...
    def test_add_large_number(self):
        self.assertEqual(calc.add(1e308, 1e308), 2e616)

    def test_add_small_negative(self):
        self.assertEqual(calc.add(1.0, -1e-10), 0.9999999999)

    def test_add_same_numbers(self):
        self.assertEqual(calc.add(17, 17),34)

    def test_add_int_float(self):
        self.assertEqual(calc.add(5, 3.8), 8.8)
...
# Creating test cases for subtraction.
    ...
    def test_subtract_zero(self):
        self.assertEqual(calc.subtract(13, 0), 13)

    def test_subtract_small_number(self):
        self.assertEqual(calc.subtract(1, 1e-15), 0.999999999999999)

    def test_subtract_int_float(self):
        self.assertEqual(calc.subtract(7, 2.8),4.2)
...
# Creating test cases for multiplication.
    ...
    def test_multiply_large(self):
        self.assertEqual(calc.multiply(2e013, 3e18), 6e+31)

    def test_multiply_floats(self):
        self.assertEqual(calc.multiply(3.2, 0.5), 1.6)

    def test_multiply_int_float(self):
        self.assertEqual(calc.multiply(7, 0.2), 1.4000000000000001)
...
# Creating test cases for division.
    ...
    def test_divide_one(self):
        self.assertEqual(calc.divide(13, 1), 13)

    def test_divide_same_numbers(self):
        self.assertEqual(calc.divide(7,7), 1)

    def test_divide_float(self):
        self.assertEqual(calc.divide(1.0, 3.0), 0.3333333333333333)

    def test_divide_int_float(self):
        self.assertEqual(calc.divide(7, 2.5), 2.8)
...
# Creating test cases for power raising.
    ...
    def test_power_zero(self):
        self.assertEqual(calc.power(0,8), 0)
    ...
    def test_power_floats(self):
        self.assertEqual(calc.power(2.3, 2.2), 6.248866394748044)

    def test_power_int_float(self):
        self.assertEqual(calc.power(2, 1.1), 2.1435469250725863)
...
# Creating test cases for square root of a number.
    ...
    def test_sqrt_large_number(self):
        self.assertEqual(calc.sqrt(1e308),1e+154)

    def test_sqrt_small_number(self):
        self.assertEqual(calc.sqrt(1e-308), 1e-154)